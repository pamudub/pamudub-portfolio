...
const ITEMS = [
  ...
  { id: "youtube", label: "YOUTUBE LINK", page: "youtube", fontSize: 68, offsetX: 8, offsetY: 6, skew: 0, skewY: -4 },
  { id: "socials", label: "SOCIALS", page: "socials", fontSize: 74, offsetX: 16, offsetY: 8, skew: -3, skewY: 5 },
  { id: "services", label: "COMMISSIONS", page: "services", fontSize: 56, offsetX: 10, offsetY: 6, skew: -4, skewY: 7 },
];
...
export default function P3Menu({ onNavigate }) {
  ...
  useEffect(() => {
    const onKey = (e) => {
      ...
      if (e.key === "Enter") { sfx.confirm(); onNavigate?.(ITEMS[active].page); }
    };
