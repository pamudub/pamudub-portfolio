...
const ITEMS = [
  { id: "i", badge: "I", title: "PLATFORMS", subtitle: "YouTube · TikTok · FB · IG", rank: 10 },
  { id: "ii", badge: "II", title: "SKILLS", subtitle: "Production Skills", rank: 10 },
  { id: "iii", badge: "III", title: "PROJECTS", subtitle: "Featured Works", rank: 10 },
        ...
        {active === 0 && (
          <div className="resume-detail-panel">
            <div className="resume-detail-top">
              ...
              <div className="resume-detail-top-title">PLATFORMS</div>
              <div className="resume-detail-top-progress">4/∞</div>
            </div>

            <div className="resume-detail-list">
              {[
                { index: "01", title: "YouTube", status: "VIDEO" },
                { index: "02", title: "TikTok", status: "SHORT" },
                { index: "03", title: "Facebook Page", status: "SOCIAL" },
                { index: "04", title: "Instagram / Reels", status: "SHORT" },
              ].map((row) => (
            ...
            <div className="resume-detail-bottom">
              ...
              <div className="resume-detail-bullets">
                <div className="resume-detail-bullet">- ติดตามและรับชมคลิปพากย์เสียง / มีม / คอนเทนต์เกม</div>
                <div className="resume-detail-bullet">- ช่องทางหลักสำหรับอัปเดตผลงานและสื่อสารกับผู้ติดตาม</div>
                <div className="resume-detail-bullet">- เปิดรับการร่วมงานและสปอนเซอร์ทุกแพลตฟอร์ม</div>
              </div>
            </div>
          </div>
        )}
        ...
        {active === 1 && (
          <div className="resume-detail-panel">
            <div className="resume-detail-top">
              ...
              <div className="resume-detail-top-title">CREATIVE ARSENAL</div>
              <div className="resume-detail-top-progress">4/∞</div>
            </div>

            <div className="resume-detail-list">
              {[
                { title: "Voice Acting & Dubbing", status: "MASTERED" },
                { title: "Video Editing (Premiere / AE)", status: "ADVANCED" },
                { title: "Script Localization", status: "ADVANCED" },
                { title: "Audio Mixing (Audition)", status: "PROFICIENT" },
              ].map((row, idx) => (
            ...
            <div className="resume-detail-bottom">
              ...
              <div className="resume-detail-bullets">
                <div className="resume-detail-bullet">- ถ่ายทอดอารมณ์ตัวละครและจังหวะคอมเมดี้/มีมได้อย่างเป็นธรรมชาติ</div>
                <div className="resume-detail-bullet">- ควบคุมงานตัดต่อ ซาวด์เอฟเฟกต์ และมิกซ์เสียงให้มีคุณภาพ</div>
                <div className="resume-detail-bullet">- ปรับบทและมุกตลกให้เข้าปากคนพากย์และโดนใจคนดูไทย</div>
              </div>
            </div>
          </div>
        )}
        ...
        {active === 2 && (
          <div className="resume-detail-panel">
            <div className="resume-detail-top">
              ...
              <div className="resume-detail-top-title">FEATURED WORKS</div>
              <div className="resume-detail-top-progress">3/∞</div>
            </div>

            <div className="resume-detail-list">
              {[
                { title: "Game Narrative & Lore Dub", status: "LONG-FORM" },
                { title: "Viral Meme & Short Clips", status: "SHORT-FORM" },
                { title: "Character Voice Acting", status: "VOICE" },
              ].map((row, idx) => (
                <div className="resume-detail-row" key={idx}>
                  <div className="resume-detail-row-index">{String(idx + 1).padStart(2, '0')}</div>
                  <div className="resume-detail-row-title">{row.title}</div>
            ...
            <div className="resume-detail-bottom">
              ...
              <div className="resume-detail-bullets">
                <div className="resume-detail-bullet">- เน้นการเล่าเรื่องที่กระชับ มุกคม และน่าติดตามตั้งแต่ต้นจนจบ</div>
                <div className="resume-detail-bullet">- คัดสรรและปรับแต่งเสียงให้เข้ากับคาแรคเตอร์ของแต่ละคอนเทนต์</div>
                <div className="resume-detail-bullet">- "ลงได้ลง ลงๆ ไปเดี๋ยวก็ดัง"</div>
              </div>
            </div>
          </div>
        )}
          ...
          <div className="resume-detail-panel">
            ...
            <div className="resume-detail-list">
              {profile.learning.map((item, idx) => (
                <div className="resume-detail-row" key={idx}>
                  <div className="resume-detail-row-index">{String(idx + 1).padStart(2, '0')}</div>
                  {/* ตัดหัวข้อนำหน้าออก (เช่น "Video & Motion:") ให้เหลือเฉพาะรายละเอียด */}
                  <div className="resume-detail-row-title">{item.includes(": ") ? item.split(": ").slice(1).join(": ") : item}</div>
            ...
            <div className="resume-detail-bottom">
              ...
              <div className="resume-detail-bullets">
                <div className="resume-detail-bullet">- พัฒนาทักษะด้านงานภาพ 3D และโมชัน เพื่อยกระดับโปรดักชันคลิปยาว</div>
                <div className="resume-detail-bullet">- ฝึกฝนเทคนิคการใช้เสียงและการออกแบบ Sound Design ให้สมจริงยิ่งขึ้น</div>
                <div className="resume-detail-bullet">- วางกลยุทธ์การขยายช่องทางและปั้นคอมมูนิตี้คนดูให้เติบโตอย่างยั่งยืน</div>
              </div>
            </div>
          </div>
        )}
