...
const ITEMS = [
  {
    id: "facebook", label: "FACEBOOK", handle: "pamudub", href: "https://www.facebook.com/profile.php?id=61558403804576", icon: "📘", barIcon: icon1,
    details: [
      { label: "USER", value: "pamudub", icon: "👤" },
      { label: "TYPE", value: "Page", icon: "📄" },
      { label: "STAT", value: "Active", icon: "🔥" }
    ],
    stats: [],
  },
  {
    id: "tiktok", label: "TIKTOK", handle: "@pamudub", href: "https://www.tiktok.com/@pamudub", icon: "🎵", barIcon: icon2,
    details: [
      { label: "USER", value: "@pamudub", icon: "👤" },
  ...
  {
    id: "instagram", label: "INSTAGRAM", handle: "@pamu.dub", href: "https://www.instagram.com/pamu.dub/", icon: "📷", barIcon: icon3,
    details: [
      { label: "USER", value: "@pamu.dub", icon: "👤" },
      { label: "TYPE", value: "Content Creator", icon: "🎨" },
      { label: "STAT", value: "Active", icon: "🔥" }
    ],
    stats: [],
